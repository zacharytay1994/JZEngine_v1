...
namespace JZEngine
{
	...
	void SpriteRenderer::DrawSprite( JZEngine::Vec2f position, JZEngine::Vec2f size, JZEngine::Vec2f scale, float rotateDegree, JZEngine::Vec3f color )
	{
		...
		JZEngine::Mat3f mat_scale = JZEngine::Mat3f::Scale(scale.x , scale.y, 1.0f);
		JZEngine::Mat3f mat_rotate = JZEngine::Mat3f::RotateZ( glfwGetTime() );
		JZEngine::Mat3f mat_translate = JZEngine::Mat3f::Translate(-300.0f, 350.0f);
